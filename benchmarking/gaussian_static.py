...
from n3.data import gaussian_mixture
...
def argument_parser():
    parser = argparse.ArgumentParser(
        description="Runner for N3 regression on Gaussian mixture dataset."
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.1,
        help="Noise level for generating data",
    )
    parser.add_argument(
        "--test_size",
        type=float,
...
def main():
    ...
    for run_idx in range(args.num_runs):
        ...
        # Dataset
        x_train, x_test, y_train, y_test = gaussian_mixture.generate_data(
        ...
        control = IdentityController(1, control_key)  # this line defines the growing nature
